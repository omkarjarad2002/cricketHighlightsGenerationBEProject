            ...
            if '-' in i:  
                ...
                if temp[0].isdigit() and temp[1].isdigit() :
                    ...
                    if First_iteration == True:
                        ...
                        print("Out_prev : ", Out_prev)
 
                        if (Score_curr-Score_prev)== 4 or (Score_curr-Score_prev)== 6 or (Out_curr-Out_prev)==1: 
                            ...
                            if(start_time < 0):
                                start_time=0
                            end_time=int(seconds)+20

                            print("Start_time : ", start_time, "End_time : ", end_time)
                     
                            path_events_subfolder=self.SubPath_Events+"/"+str(start_time)+str("_")+str(end_time)+".mp4"
                            
                            self.Crop_Video(start_time,end_time,path_events_subfolder)
                            
                            # try:  
                            #     os.makedirs(path_events_subfolder,exist_ok=True)
                            # except OSError as error:  
                        ...
                        #     print("Four : ","Score_curr : ", Score_curr, "Score_prev : ", Score_prev)
                        #     #Splitting the filname and getting the seconds info from it 
                        #     second=self.all_files[j].split('_')
                        #     second=second[1].split('.')
                        #     seconds=second[0]
                        ...
                        #     print("Six : ","Score_curr : ", Score_curr, "Score_prev : ", Score_prev)
                        #     #Splitting the filname and getting the seconds info from it 
                        #     second=self.all_files[j].split('_')
                        #     second=second[1].split('.')
                        #     seconds=second[0]
                        ...
                        #     if(Out_curr < 10 & Out_prev < 9):
                        #         print("Out : ","Out_Curr : ", Out_curr, "Out_prev : ", Out_prev)
                        ...
                        # else:
                        #     print("Else : ","Score_curr : ", Score_curr, "Score_prev : ", Score_prev)
                        #     Score_prev=Score_curr
                        #     Out_prev=Out_curr 
